...
export type MenuItemId = RecordId<"menu-item">;
export type MenuModifierGroupId = RecordId<"menu-modifier-group">;
export type MenuModifierOptionId = RecordId<"menu-modifier-option">;
export type MenuVariantId = RecordId<"menu-variant">;
